...
const items = [
  {
    ...
    title: "1. WHAT INFORMATION DO WE COLLECT?",
    description: `Personal information you disclose to us
...
<b> Personal Information Provided by You.</b> We collect names; phone numbers; email addresses; mailing addresses; job titles; contact preferences; billing addresses; debit/credit card numbers; and other similar information.

<b> Payment Data.</b> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. 

All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.

<b>Information automatically collected
In Short:</b> Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our website.
...
In Short:</b> We may collect limited data from public databases, marketing partners, and other outside sources.
...
In order to enhance our ability to provide relevant marketing, offers and services to you and update our records, we may obtain information about you from other sources, such as public databases, joint marketing partners, affiliate programs, data providers, as well as from other third parties. This information includes mailing addresses, job titles, email addresses, phone numbers, intent data (or user behaviour data), Internet Protocol (IP) addresses, social media profiles, social media URLs and custom profiles, for purposes of targeted advertising and event promotion.`,
  },
  {
    id: "use-information",
    title: "2. HOW DO WE USE YOUR INFORMATION?",
    description: `<b>In Short:</b> We process your information for purposes based on legitimate business interests, the fulfilment of our contract with you, compliance with our legal obligations, and/or your consent.

We use personal information collected via our website for a variety of business purposes described below. We process your personal information for these purposes in reliance on our legitimate business interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations. We indicate the specific processing grounds we rely on next to each purpose listed below.

We use the information we collect or receive:
<b> To facilitate account creation and logon process.</b> If you choose to link your account with us to a third-party account (such as your Google or Facebook account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract.

<b> To post testimonials.</b> We post testimonials on our website that may contain personal information. Prior to posting a testimonial, we will obtain your consent to use your name and the content of the testimonial. If you wish to update, or delete your testimonial, please contact us at praveen.s@pasovit.com and be sure to include your name, testimonial location, and contact information.
...
<b>To enforce our terms, conditions, and policies for business purposes, to comply with legal and regulatory requirements or in connection with our contract.

To respond to legal requests and prevent harm.</b> If we receive a subpoena or other legal request, we may need to inspect the data we hold to determine how to respond.

<b>Fulfil and manage your orders.</b> We may use your information to fulfil and manage your orders, payments, returns, and exchanges made through the Website.
...
<b>To send you marketing and promotional communications.</b> We and / or our third-party marketing partners may use the personal information you send to us for our marketing purposes if this is in accordance with your marketing preferences. For example, when expressing an interest in obtaining information about us or our website, subscribing to marketing or otherwise contacting us, we will collect personal information from you. you can opt-out of our marketing emails at any time (see the <span class='text-blue-900'>“WHAT ARE YOUR PRIVACY RIGHTS?”</span> below).
...
For other business purposes. We may use your information for other business purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our website, products, marketing, and your experience. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.`,
  ...
  {
    id: "information-shared-with-anyone",
    title: "3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?",
    description: `<b>In Short:</b> We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfil business obligations.
...
<b>Performance of a Contract:</b> Where we have entered into a contract with you, we may process your personal information to fulfil the terms of our contract.
...
If you are a resident in the EEA or UK and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: <a href='https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm' class='text-blue-900 underline' target='_blank'> https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm.</a>

If you are a resident in Switzerland, the contact details for the data protection authorities are available here: <a href='https://www.edoeb.admin.ch/edoeb/en/home.html' class='text-blue-900 underline' target='_blank'> https://www.edoeb.admin.ch/edoeb/en/home.html.</a>

Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our website. To opt-out of interest-based advertising by advertisers on our website visit <a href='http://www.aboutads.info/choices/' class='text-blue-900 underline' target='_blank'> http://www.aboutads.info/choices/.</a>`,
  },
  {
...
You may contact us by email at <a href='mailto:privacy@pasovit.com' target='_blank' class='text-blue-900 underline'> privacy@pasovit.com,</a> or by referring to the contact details at the bottom of this document.
...
Pasovit Technologies Private Limited has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding12 months. Pasovit Technologies Private Limited will not sell personal information in the future belonging to website visitors, users and other consumers.
...
Upon receiving your request, we will need to verify your identity to determine you are the same person about whom we have the information in our system. These verification efforts require us to ask you to provide information so that we can match it with information you have previously provided us. For instance, depending on the type of request you submit, we may ask you to provide certain information so that we can match the information you provide with the information

we already have on file, or we may contact you through a communication method (e.g. phone or email) that you have previously provided to us. We may also use other verification methods as the circumstances dictate.
...
Praveen Sankaran
715 A, Spencer Plaza, 7th floor, No. 768-769, Mount Road, Anna Salai
    ...
    <div>
      ...
      <section className="max-w-6xl mx-auto mt-20">
        ...
        <p className="text-[#262626] mt-5  ">
          Thank you for choosing to be part of our community at Pasovit
          Technologies Private Limited, doing business as Pasovit{" "}
          <b> (“Pasovit,” “we,” “us,” or “our”).</b> If you have any questions
          or concerns about this privacy notice or our practices with regard to
          ...
          or events. <br /> <br /> In this privacy notice, if we refer to:
          <b>“Website,”</b> we are referring to any website of ours that
          references or links to this policy <br /> <br />
          <b>“Services,”</b> we are referring to our Website, and other related
          services, including any sales, marketing, or events. <br /> <br /> The
          purpose of this privacy notice is to explain to you in the clearest
          ...
          our Services immediately. <br /> <br />
          <b>
        ...
        <div className="mt-10">
          <h3 className="text-xl text-[#262626] mb-5 font-[500]">
            TABLE OF CONTENTS:
          </h3>
          ...
          <div>
            {contents.map((item, index) => (
              <p
                className="text-[#001E8A] text-sm font-[500] underline cursor-pointer mb-1"
                key={index}
        ...
        <div className="space-y-10 mt-10">
          {items.map((item, index) => (
            <div id={item.id} key={index}>
              <h2 className="text-lg text-[#001E8A]  font-[500] ">
                {item.title}
              </h2>
              <p
                className="text-[#262626] text-justify mt-5 whitespace-break-spaces "
